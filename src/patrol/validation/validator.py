...
from src.patrol.validation.persistence import migrate_db
from src.patrol.validation.persistence.miner_score_respository import DatabaseMinerScoreRepository
from src.patrol.validation.scoring import MinerScoreRepository
import asyncio
import aiohttp
import time
import logging
...
from src.patrol.protocol import PatrolSynapse
from src.patrol.constants import Constants
from src.patrol.validation.target_generation import TargetGenerator
...
from src.patrol.validation.graph_validation.bittensor_validation_mechanism import BittensorValidationMechanism
from src.patrol.validation.miner_scoring import MinerScoring
from src.patrol.validation.scoring import MinerScore

from bittensor.core.metagraph import AsyncMetagraph
import bittensor_wallet as btw
from src.patrol.validation.weight_setter import WeightSetter
...
async def start():
    ...
    from src.patrol.validation.config import DB_URL, NETWORK, NET_UID, WALLET_NAME, HOTKEY_NAME, BITTENSOR_PATH, ENABLE_WEIGHT_SETTING, ARCHIVE_SUBTENSOR, SCORING_INTERVAL_SECONDS
...
def boot():
    try:
        from src.patrol.validation.config import DB_URL
        migrate_db(DB_URL)
        asyncio.run(start())
